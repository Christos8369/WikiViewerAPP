...
//    Η δημιουργία της DB γίνεται μέσα από το persistance.xml
//      <property name="javax.persistence.jdbc.url" value="jdbc:derby:C:\derby\WikiViewerAPP_DB;create=true"/>
...
//      και με τον entityFactoryManager που γίνεται στην Main του προγράμματος έτσι ώστε αν κάποιος πάει και σβήσει τον φάκελο αυτός ξαναδημιουργείται όπως το είχες και εσύ 
//      αλλά όχι στον C:\, αλλά μέσα στον φάκελο που είναι το project έτσι ώστε αν κάποιος το πάρει και το τρέξει στον υπολογιστή του να μπορεί να τρέχει απροβλημάτιστα
//      και με JPA που έχει γίνει τώρα η δημιουργία των tables γίνεται με βάση τα Pojo class για αυτό και δεν υπάρχει query.
//      να δω πως θα πετύχω να κάνω αυτό το γαμάτο με το ✅ που έχεις κάνει    
    
    
    // <editor-fold desc="Αυτά είναι όλα JDBC αρχικοποίηση και όχι JPA">

//    /**
//     * JDBC URL for connecting to the embedded Apache Derby database used by WikiViewerAPP. The 'create=true' parameter ensures the database is created locally on the user's machine the first time the application is run.
//     */
//    private static final String DB_URL
//            = "jdbc:derby:WikiViewerAPP_DB;create=true";
//
//    /**
//     * Initializes the database by setting the Derby system home directory, loading the database driver, checking if the database already exists, and creating the required tables if necessary.
//     */
...
//     * @throws SQLException if an error occurs during table creation. if need, we have to run an alter table SQL command if we want to change it after the first run of the application ( adding a column for example )
//     */
////    private static void createTables(Statement stmt) throws SQLException {
////        // SQL statement to create the COMMENT table, which holds bellow attribues.
////        String createCategotyTable = """
...
////            STATISTICS_ID INTEGER GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
////            SEARCHEDWORD VARCHAR(255) NOT NULL
////        )
////        """;
////
...
////
////        stmt.executeUpdate(createStatisticsTable);
////        System.out.println("STATISTICS Table Created.");
////
////        stmt.executeUpdate(createCategotyTable);
////        System.out.println("CATEGORY Table Created.");
////    }
//
//    // Δεν χρειάζεται αυτήν η μέθοδος γιατί κάθε φορά που ανοίγουμε το πρόγραμμα ΔΕΝ αρχικοποιούμε την βάση.
